// Existing base CNewPlayerTags implementation, independently identified R5 family.
#include "main.h"
extern HealthBarVertices1_s HealthBarBDRVertices1[4],HealthBarBGVertices1[4],HealthBarVertices1[4];
