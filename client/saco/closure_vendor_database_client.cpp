...
typedef char R5DatabaseClientSize[(sizeof(LightweightDatabaseClient)==8)?1:-1];
typedef char R5DatabaseClientPeerPointerSize[(sizeof(RakPeerInterface*)==4)?1:-1];
typedef char R5DatabaseClientPlayerIDSize[(sizeof(PlayerID)==6)?1:-1];
typedef char R5DatabaseClientFilterSize[(sizeof(DatabaseFilter)==49)?1:-1];
typedef char R5DatabaseClientUpdateSize[(sizeof(DatabaseCellUpdate)==45)?1:-1];
