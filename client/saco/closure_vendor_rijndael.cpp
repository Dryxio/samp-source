...
// Complete vendor API structures, packed as in the current R5 workflow.
typedef char R5RijndaelKeySize[(sizeof(keyInstance)==282)?1:-1];
typedef char R5RijndaelCipherSize[(sizeof(cipherInstance)==21)?1:-1];
