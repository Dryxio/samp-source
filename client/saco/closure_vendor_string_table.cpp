...
// Full original types, including the owned StrAndBool element and singleton.
typedef char R5StringTableSize[(sizeof(StringTable)==12)?1:-1];
typedef char R5StringTableElementSize[(sizeof(StrAndBool)==5)?1:-1];
