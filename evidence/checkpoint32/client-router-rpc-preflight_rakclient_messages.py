...
rows=json.loads(Path('build/agent-independent/rakclient-messages-trial1-discovery/discovery-attached.json').read_text())['rows']
...
proposal=json.loads(Path('build/agent-independent/rakclient-messages-proposal.json').read_text())
...
Path('build/agent-independent/rakclient-messages-reviewed-manifest.json').write_text(json.dumps(out,indent=2)+'\n')
Path('build/agent-independent/rakclient-messages-seeds.json').write_text(json.dumps(out['seeds'],indent=2)+'\n')
