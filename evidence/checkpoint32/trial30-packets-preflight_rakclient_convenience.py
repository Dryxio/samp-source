...
rows=json.loads(Path('build/agent-independent/rakclient-convenience-trial1-discovery/discovery-attached.json').read_text())['rows']
...
proposal=json.loads(Path('build/agent-independent/rakclient-convenience-proposal.json').read_text())
...
Path('build/agent-independent/rakclient-convenience-reviewed-manifest.json').write_text(json.dumps(out,indent=2)+'\n')
Path('build/agent-independent/rakclient-convenience-seeds.json').write_text(json.dumps(out['seeds'],indent=2)+'\n')
