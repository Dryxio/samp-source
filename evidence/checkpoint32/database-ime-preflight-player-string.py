...
run='cp32-player-id-string-trial1';unit='closure_vendor_player_id_string'
...
roots={'?ToString@PlayerID@@QBEPAD_N@Z':0x337a0}
...
Path('build/player-id-string-reviewed-manifest.json').write_text(json.dumps(manifest,indent=2)+'\n')
