...
spec=json.load(open(sys.argv[1]));old=json.load(open('config/checkpoint32/'+spec['previous']+'-contract.json'));new=json.load(open('build/actor-contract-draft.json'));prior={(r['unit'],r['rva'],r['size'],r['kind']):r for r in old['regions']}
