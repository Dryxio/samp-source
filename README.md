...
**33,024 code bytes verified — 3.55% of the original code section.**

Already covered: parts of actor creation and deletion, entity geometry, weapon lookup, game commands, native pools and shared utilities.
...
[Verified coverage](evidence/checkpoint32/coverage-current.json) · [Latest accepted batch](evidence/checkpoint32/common-acceptance.json) · [Development log](evidence/checkpoint32/PROGRESS.md)
