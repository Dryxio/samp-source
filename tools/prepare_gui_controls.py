...
NAMES = [*(f'CDXUT{x}::Render' for x in ['ComboBox','Button','CheckBox','Slider','Static']), *(f'CDXUT{x}::UpdateRects' for x in ['Control','ComboBox','EditBox','Slider','CheckBox','ScrollBar']), 'CDXUTScrollBar::ShowItem', 'CDXUTScrollBar::Cap', 'CDXUTScrollBar::UpdateThumbRect']
def prepare():
