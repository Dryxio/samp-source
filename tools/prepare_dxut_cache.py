...
NAMES=['DXUTGetGlobalResourceCache','CDXUTResourceCache::~CDXUTResourceCache','CDXUTResourceCache::OnResetDevice','CDXUTResourceCache::OnLostDevice','CDXUTResourceCache::OnDestroyDevice']
def prepare():
