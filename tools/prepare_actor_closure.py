...
UNITS={
 'closure_world':('game/entity.cpp',['GetModelIndex','GetMatrix','SetMoveSpeedVector','SetTurnSpeedVector','Add','Remove','TeleportTo','SetMatrix','GetMoveSpeedVector','GetTurnSpeedVector','IsAdded','ApplyTurnSpeed','GetDistanceFromCentreOfMassToBaseOfModel','GetBoundCentre','GetBoundRect','GetDistanceFromCamera','GetDistanceFromPoint','EnforceWorldBoundries','HasExceededWorldBoundries','SetCollisionChecking','IsCollisionCheckingEnabled','SetGravityProcessing','SetWaitingForCollision','DisableStreaming','EnableTunnelTransition','SetApplySpeed','MakeNonCollidable','SetClumpAlpha','GetWorldBoundRadius','SetEulerAngles'],'CEntity'),
