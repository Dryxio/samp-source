...
param([string]$Run,[string]$Units,[ValidateSet("Ob1","Ob2")][string]$Inline="Ob1",[switch]$PoolStrings,[ValidateSet("Ot","Os")][string]$Favor="Ot",[ValidateSet("default","G5","G6","G7")][string]$Cpu="default",[switch]$PreciseFloat)
